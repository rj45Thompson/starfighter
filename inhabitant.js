...
// sim-minute (stale beliefs fade); predictions are recorded BEFORE the observation that scores them (no hindsight - enforced by a strict min-age guard + predT<t in every calibration record).
